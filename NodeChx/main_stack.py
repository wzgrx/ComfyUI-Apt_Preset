...
class Stack_CN_union:
    ...
    def INPUT_TYPES(s):
        return {
            ...
            "optional": {
                "controlNet": (['None'] + folder_paths.get_filename_list("controlnet"),),
                "type": (["None"] + list(UNION_CONTROLNET_TYPES.keys()),),
    ...
    def load_controlnet(self,  
        ...
        if (controlNet != "None"
            ...
            control_net = ControlNetLoader().load_controlnet(controlNet)[0]
            control_net_with_type = SetUnionControlNetType().set_controlnet_type(control_net, type)[0]
            stack_list.append((control_net_with_type, image, strength, start_percent, end_percent))
