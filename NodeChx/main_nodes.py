...
-attention: Attention implementation. Options include flash-attention2 and nunchaku-fp16.
-The nunchaku-fp16 uses FP16 attention, offering ~1.2× speedup. 
-Note that 20-series GPUs can only use nunchaku-fp16.
    """

    def process_settings(self, node_id, width, height, steps, cfg, sampler, scheduler, guidance, device="default", lora=None, lora_strength=1.0,
                         cache_threshold=0, cpu_offload="auto", attention="nunchaku-fp16",
                        vae=None, clip1=None, unet_name=None, data_type=None, lora_stack=None,over_model=None,
