...
class Stack_LoRA:
    ...
    def INPUT_TYPES(cls):
        ...
        return {
            "required": {
                "lora_name_1": (loras,),
                "weight_1": ("FLOAT", {"default": 1.0, "min": -3.0, "max": 3.0, "step": 0.1}),
                "lora_name_2": (loras,),
                "weight_2": ("FLOAT", {"default": 1.0, "min": -3.0, "max": 3.0, "step": 0.1}),
                "lora_name_3": (loras,),
                "weight_3": ("FLOAT", {"default": 1.0, "min": -3.0, "max": 3.0, "step": 0.1}),
            },
            "optional": {
...
class sum_stack_AD:
    ...
    def merge(self, model=None,ad_stack=None,chx_Merge=None, positive=None, ipa_stack=None, lora_stack=None, pos_sch_stack=None, cn_stack=None, context=None,latent_stack=None,):
