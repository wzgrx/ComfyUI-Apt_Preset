...
"list_ListGetByIndex": list_GetByIndex,#wed   
"list_ListSlice": list_Slice,#wed   
"list_MergeList": list_Merge, #wed   
"list_num_range": list_num_range,
"list_sch_Value":list_sch_Value,

"batch_BatchGetByIndex": BatchGetByIndex,#wed   
"batch_BatchSlice": BatchSlice,#wed   
...
"create_Mask_match_shape": create_Mask_match_shape,   #---------------------测试比例
...
#----------prompt----------------
"excel_Prompter":excel_Prompter,       #---------------------测试比例
