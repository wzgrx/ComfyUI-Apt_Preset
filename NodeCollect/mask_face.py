...
class Mask_face_detect:
    ...
    def run(self, image, skin, left_brow, right_brow, left_eye, right_eye, eyeglasses,
            left_ear, right_ear, earring, nose, mouth, upper_lip, lower_lip,
            neck, necklace, cloth, hair, hat):
        masks = mask_BiSeNet(image, skin, left_brow, right_brow, left_eye, right_eye, eyeglasses,
            left_ear, right_ear, earring, nose, mouth, upper_lip, lower_lip,
            neck, necklace, cloth, hair, hat)
        return (masks, )
