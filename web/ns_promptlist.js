...
function setupSocketListeners() {
    ...
    api.addEventListener("ns_promptlist_enum", (event) => {
        ...
        // Update all sum_text_adv nodes
        app.graph._nodes.forEach(node => {
            if (node.type === "sum_text_adv") {
    ...
    api.addEventListener("ns_promptlist_set_widgets", (event) => {
        ...
        if (targetNodeId) {
            ...
            if (targetNode && targetNode.type === "sum_text_adv") {
            ...
            if (activeNode && activeNode.type === "sum_text_adv") {
...
function hookSelectChange(node) {
    if (node.type !== "sum_text_adv") return;
