...
class Stack_IPA_SD3:
    ...
    def ipa_stack(self, image, ipadapter, image_embed, weight, mask=None, ipa3_stack=None):
        if ipa3_stack is None:
            ipa_list = []
        else:
            ipa_list = list(ipa3_stack)  
