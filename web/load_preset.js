        ...
        if (node.comfyClass == "load_basic") {
            ...
            function messageHandler(event) {
                ...
                if (node.id == event.detail.node) {
                    ...
                    node.widgets[13].value = (event.detail.message['positive'])?event.detail.message['positive']:"beautiful detailed glow,a girl";
        ...
        if (node.comfyClass == "load_FLUX") {
            ...
            function messageHandler(event) {
                ...
                if (node.id == event.detail.node) {
                    ...
                    node.widgets[17].value = (event.detail.message['positive'])?event.detail.message['positive']:"beautiful detailed glow,a girl";
        ...
        if (node.comfyClass == "load_SD35") {
            ...
            function messageHandler(event) {
                ...
                if (node.id == event.detail.node) {
                    ...
                    node.widgets[16].value = (event.detail.message['positive'])?event.detail.message['positive']:"beautiful detailed glow,a girl";
