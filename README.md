...
| **- Basic_Ksampler_simple**     | **精简参数采样器**     |
| ------------------------------- | --------------- |
| **- Basic_Ksampler_mid**        | **半参数采样器**      |
| **- Basic_Ksampler_full**       | **完整参数采样器**     |
| **- Basic_Ksampler_custom**     | **自定义基础采样**     |
| **- Basic_Ksampler_adv**        | **高级采样<br>**    |
| **- Basic_Ksampler_batch**      | **调度批次采样器**     |
| **- Chx_Ksampler_refine**       | **基础放大采样**      |
| **- Chx_ksampler_tile**         | **tile 放大采样**   |
| **- Chx_Ksampler_mix**          | **混合采样器**       |
| **- Chx_Ksampler_texture**      | **纹理采样器**       |
| **- Chx_Ksampler_dual_paint**   | **双区重绘**        |
| **- Chx_Ksampler_dual_area**    | **双区采样**        |
| **- Chx_Ksampler_inpaint**      | **重绘采样器**       |
| **- Chx_Ksampler_VisualStyle**  | **风格一致性采样**     |
| **- Chx_ksampler_Deforum**      | **简单的首尾帧**      |
| **- Chx_ksampler_Deforum_math** | **可以用数学公式驱动变换** |
| **- Chx_ksampler_Deforum_sch**  | **可以用调度数据驱动变换** |
