...
class Data_fullData:
    ...
    def convert(self, context=None, **kwargs):
        ctx = new_context(context, **kwargs)
...
class Data_select:
    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                "context": ("RUN_CONTEXT",),
                "type": (["model", "clip", "positive", "negative", "vae", "latent", "images", "mask", "any"],{}),
            },
        }
...
class Data_presetData:
    ...
    def convert(self, context=None):
        ...
        negwidth = context.get("negwidth", None)
...
class sum_load:
    ...
    def INPUT_TYPES(cls):
        ...
        CLIP_TYPE = ["sdxl", "sd3", "flux", "hunyuan_video", "stable_diffusion", "stable_audio", "mochi", "ltxv", "pixart", "cosmos", "lumina2"]
        ...
        return {
            "required": {
                ...
                "unet_Weight_Dtype": (["None"]+ ["fp8_e4m3fn", "fp8_e4m3fn_fast", "fp8_e5m2"], ),
...
class chx_easy_text:
    ...
    def prompt_styler(self, context, pos, neg, style, pos1="", neg1=""):
        ...
        if pos1!= None and pos1!= "":
            pos = pos + "," + pos1
        if neg1!= None and neg1!= "":
            neg =neg + ","+ neg1
