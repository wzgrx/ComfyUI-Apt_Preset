...
class Stack_pre_Mark:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "rescale_crop": ("FLOAT", {"default": 1.00, "min": 0.01, "max": 10.00, "step": 0.01}),
    ...
    def visualize(self,  mask_mode, 
                  ...
                  smoothness, mask_expand,mask_min, mask_max,crop_to_mask,  
                  expand_width_crop, expand_height_crop, rescale_crop,  
                  tapered_corners,divisible_by ):  
        
        mark_stack = (
             mask_mode,
            ignore_threshold, outline_thickness,
            smoothness, mask_expand,            
            tapered_corners, mask_min, mask_max, crop_to_mask, expand_width_crop,expand_height_crop, rescale_crop,divisible_by
        )
        return (mark_stack,)
    


class Stack_pre_Mark_easy:
    @classmethod
    def INPUT_TYPES(cls):
        return {
            "required": {
    ...
    def visualize(self, mask_mode, 
        ...
        mark_stack = (
            ...
            crop_to_mask, expand_width_crop, expand_height_crop, rescale_crop, divisible_by
        )
        return (mark_stack,)
