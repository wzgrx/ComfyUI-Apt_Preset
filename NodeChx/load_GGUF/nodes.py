...
class UnetLoaderGGUFAdvanced2(UnetLoaderGGUF2):
    @classmethod
    def INPUT_TYPES(s):
        unet_names = [x for x in folder_paths.get_filename_list("unet_gguf")]
        return {
...
class DualCLIPLoaderGGUF2(CLIPLoaderGGUF2):
    @classmethod
    def INPUT_TYPES(s):
...
class TripleCLIPLoaderGGUF2(CLIPLoaderGGUF2):
    @classmethod
    def INPUT_TYPES(s):
        file_options = (s.get_filename_list(), )
        return {
...
class QuadrupleCLIPLoaderGGUF2(CLIPLoaderGGUF2):
    @classmethod
    def INPUT_TYPES(s):
        file_options = (s.get_filename_list(), )
        return {
