...
app.registerExtension({
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name === "pack_Pack" || nodeData.name === "batch_CreateBatch" || nodeData.name === "creat_image_batch"|| nodeData.name === "creat_mask_batch") {
        ...
        // 如果节点名称为"creat_any_List"或"list_MergeList"
        else if (nodeData.name === "creat_any_List" || nodeData.name === "list_MergeList") {
