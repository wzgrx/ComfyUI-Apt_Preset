...
"flow_auto_pixel":flow_auto_pixel,   #修改成上，下采样模式
...
"creat_mask_batch_input": creat_mask_batch_input,#wed#(Deprecated)
"creat_image_batch_input": creat_image_batch_input,#wed#(Deprecated)
