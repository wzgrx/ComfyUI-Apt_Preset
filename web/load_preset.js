...
//#region 
        ...
        if (node.comfyClass == "load_only_clip") {
            ...
            function messageHandler(event) {
                ...
                if (node.id == event.detail.node) {
                    node.widgets[1].value = (event.detail.message['clip_type'])?event.detail.message['clip_type']:"None";
                    node.widgets[2].value = (event.detail.message['clip1'])?event.detail.message['clip1']:"None";
                    node.widgets[3].value = (event.detail.message['clip2'])?event.detail.message['clip2']:"None";
                    node.widgets[4].value = (event.detail.message['guidance'])?event.detail.message['guidance']:"3.5";
                    node.widgets[5].value = (event.detail.message['clip3'])?event.detail.message['clip3']:"None";
                    node.widgets[6].value = (event.detail.message['vae'])?event.detail.message['vae']:"A-840000-ema-pruned-real.pt";
                    node.widgets[7].value = (event.detail.message['width'])?event.detail.message['width']:"512";
                    node.widgets[8].value = (event.detail.message['height'])?event.detail.message['height']:"512";
                    node.widgets[9].value = (event.detail.message['batch'])?event.detail.message['batch']:"1";
                    node.widgets[10].value = (event.detail.message['steps'])?event.detail.message['steps']:"20";
                    node.widgets[11].value = (event.detail.message['cfg'])?event.detail.message['cfg']:"8";
                    node.widgets[12].value = (event.detail.message['sampler'])?event.detail.message['sampler']:"euler a";
                    node.widgets[13].value = (event.detail.message['scheduler'])?event.detail.message['scheduler']:"normal";
                    node.widgets[14].value = (event.detail.message['positive'])?event.detail.message['positive']:"a girl,sea";
                    node.widgets[15].value = (event.detail.message['negative'])?event.detail.message['negative']:"worst quality, low quality";
        ...
        if (node.comfyClass == "load_clip") {
            ...
            function messageHandler(event) {
                ...
                if (node.id == event.detail.node) {
                    ...
                    node.widgets[15].value = (event.detail.message['scheduler'])?event.detail.message['scheduler']:"normal";
                    node.widgets[16].value = (event.detail.message['positive'])?event.detail.message['positive']:"a girl,sea";
                    node.widgets[17].value = (event.detail.message['negative'])?event.detail.message['negative']:"worst quality, low quality";
        ...
        if (node.comfyClass == "text_manual") {
            ...
            function messageHandler(event) {
                ...
                if (node.id == event.detail.node) {
                    node.widgets[1].value = (event.detail.message['positive'])?event.detail.message['positive']:"XX";
                    node.widgets[2].value = (event.detail.message['negative'])?event.detail.message['negative']:"XX";
                }
            }
            api.addEventListener("my.custom.message", messageHandler);
        }
