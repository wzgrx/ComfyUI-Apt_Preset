  ...
  async nodeCreated(node) {
    ...
    function messageHandler(event) {
      if (node.id == event.detail.node) {
        ...
        node.widgets[5].value = event.detail.message["device_id"] ? event.detail.message["device_id"] : "None";
        node.widgets[6].value = event.detail.message["data_type"] ? event.detail.message["data_type"] : "None";
        node.widgets[7].value = event.detail.message["i2f_mode"] ? event.detail.message["i2f_mode"] : "None";

        node.widgets[8].value = event.detail.message["clip1"] ? event.detail.message["clip1"] : "None";
        node.widgets[9].value = event.detail.message["clip2"] ? event.detail.message["clip2"] : "None";
        node.widgets[10].value = event.detail.message["guidance"] ? event.detail.message["guidance"] : "3.5";
        node.widgets[11].value = event.detail.message["vae"] ? event.detail.message["vae"] : "None";
        node.widgets[12].value = event.detail.message["width"] ? event.detail.message["width"] : "1024";
        node.widgets[13].value = event.detail.message["height"] ? event.detail.message["height"] : "1024";
        node.widgets[14].value = event.detail.message["steps"] ? event.detail.message["steps"] : "8";
        node.widgets[15].value = event.detail.message["cfg"] ? event.detail.message["cfg"] : "1";
        node.widgets[16].value = event.detail.message["sampler"] ? event.detail.message["sampler"] : "None";
        node.widgets[17].value = event.detail.message["scheduler"] ? event.detail.message["scheduler"] : "None";
      }
