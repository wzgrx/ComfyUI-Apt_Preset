...
class Stack_IPA:
    ...
    def ipa_stack(self,  image, preset, weight, weight_type, combine_embeds, start_at, end_at, embeds_scaling, attn_mask=None, image_negative=None, ipa_stack=None):
...
class Stack_Redux:
    ...
    def redux_stack(self,style_model, clip_vision, image, crop, sharpen, patch_res, style_strength, prompt_strength, blend_mode, noise_level, mask=None, guidance=30, redux_stack=None):
        # 初始化redux_list
        redux_list = []
