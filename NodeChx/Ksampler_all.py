...
class chx_Ksampler_Kontext_inpaint:# 遮罩选项，可参与采样或不参与采样
    def __init__(self):
        pass
...
class chx_Ksampler_Kontext:   #0803仅遮罩数据处理
    ...
    def run(self, context, seed, image_output="Preview", image=None, mask=None, steps=0, denoise=1, prompt_weight=0.5,
