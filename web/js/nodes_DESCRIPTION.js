...
const categories = ["Apt_Preset",];
app.registerExtension({
	name: "Apt_Preset.HelpPopup",
	async beforeRegisterNodeDef(nodeType, nodeData) {
  
  if (app.ui.settings.getSettingValue("Apt_Preset.HelpPopup") === false) {
    return;
    }
		try {
        ...
        if (nodeData?.category?.startsWith(category)) {
			...
			console.error("Error in registering Apt_Preset.HelpPopup", error);
		}
	},
});
